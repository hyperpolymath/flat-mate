...
Thank you for your interest in contributing to flat-mate. This document
...
- <a href="https://nodejs.org/" class="js">Node</a> 20+ (web and mobile
  workspaces)

- [verisimdb](https://github.com/hyperpolymath/verisimdb) running
...
Consider which app layer the feature belongs to (API, web, mobile,
shared)
...
- [`good` `first`
  `issue`](https://github.com/hyperpolymath/flat-mate/labels/good%20first%20issue)
  – Simple tasks

- [`help`
  `wanted`](https://github.com/hyperpolymath/flat-mate/labels/help%20wanted)
  – Community help needed

- [`documentation`](https://github.com/hyperpolymath/flat-mate/labels/documentation)
  – Docs improvements
