...
[arabic]
. Navigate to
https://github.com/hyperpolymath/flat-mate/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/flat-mate/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/flat-mate/discussions[GitHub
Discussions]
...
_Thank you for helping keep flat-mate and its users safe._
