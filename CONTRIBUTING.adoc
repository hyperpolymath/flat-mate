...
* https://deno.land/[Deno] 1.40+ (API server)
* https://nodejs.org/[Node.js] 20+ (web and mobile workspaces)
* https://github.com/hyperpolymath/verisimdb[verisimdb] running locally
on port 8080
...
* https://github.com/hyperpolymath/flat-mate/labels/good%20first%20issue[`+good first issue+`]
– Simple tasks
* https://github.com/hyperpolymath/flat-mate/labels/help%20wanted[`+help wanted+`]
– Community help needed
* https://github.com/hyperpolymath/flat-mate/labels/documentation[`+documentation+`]
– Docs improvements
...
under the link:LICENSE[MPL-2.0].
