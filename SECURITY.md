...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/flat-mate/security/advisories/new)
...
- This repository (`hyperpolymath/flat-mate`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/flat-mate/security/advisories)
...
When using flat-mate, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/flat-mate/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/flat-mate/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/flat-mate/discussions) |
...
*Thank you for helping keep flat-mate and its users safe.*
